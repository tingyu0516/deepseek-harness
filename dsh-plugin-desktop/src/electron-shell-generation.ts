...
export class ElectronShellGeneration {
  ...
  private removeRendererAccessHeader: (() => void) | undefined
  ...
  async mount(beforeInteractive?: () => void): Promise<void> {
    ...
    try {
      ...
      this.removeRendererAccessHeader = installRendererAccessHeader(
        window,
        new URL(spec.url).origin,
  ...
  async release(): Promise<void> {
    ...
    this.removeRendererAccessHeader?.()
    this.removeRendererAccessHeader = undefined
