...
Hu Tao-themed desktop pet plugin for DSH Desktop — the companion is a
community-sourced Live2D model (placed locally under `assets/live2d/`, see
[LIVE2D](../dsh-plugin-pet-core/LIVE2D.md)) framed with the Wangsheng palette
of the bundled Hu Tao character theme for its speech bubble.
...
- Registers a tray menu (`Pet · Hu Tao`) with a Show companion checkbox;
